...
import { Compass, GraduationCap, Star, Wrench, Bug } from "lucide-react";
import {
  LayoutDashboard,
  Plane,
  Building2,
...
const allMenuItems = [
  ...
  { title: "Student Baggage", url: "/admin/student-baggage", icon: GraduationCap },
  ...
  { title: "AI Usage", url: "/admin/ai-usage", icon: BarChart3 },
  { title: "AI Settings", url: "/admin/ai-settings", icon: Brain },
  { title: "Trip Requests", url: "/admin/trip-requests", icon: Compass },
  { title: "Affiliates", url: "/admin/affiliates", icon: Share2 },
  { title: "Featured Items", url: "/admin/featured-items", icon: Star },
  { title: "Utility APIs", url: "/admin/utility-apis", icon: Wrench },
  { title: "Platform Features", url: "/admin/platform-features", icon: Sparkles },
];
...
export function AdminSidebar() {
  ...
  const mainMenuItems = isSuperAdmin
    ...
    : [
        ...
        { title: "Theme", url: "/admin/theme", icon: Paintbrush },
        { title: "Admin Appearance", url: "/admin/admin-appearance", icon: LayoutTemplate },
      ];
