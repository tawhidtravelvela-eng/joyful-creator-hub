...
const FlightDetail = () => {
  ...
  return (
    <Layout>
      ...
      <div className="relative overflow-hidden wl-detail" data-wl-surface="detail">
              ...
              <Card className="border-0 shadow-lg shadow-primary/[0.03] overflow-hidden">
                ...
                <CardContent className="px-6 pb-5">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {[
                      { icon: Luggage, label: "Checked Baggage", desc: flight.baggageAllowance?.checkin || "Check with airline", gradient: "from-info/50/10 to-info/5", iconBg: "bg-info/50/10 text-info dark:text-info" },
                      { icon: Briefcase, label: "Cabin Baggage", desc: flight.baggageAllowance?.cabin || "Check with airline", gradient: "from-success/50/10 to-success/5", iconBg: "bg-success/50/10 text-success dark:text-success" },
